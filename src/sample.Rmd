We first begin by importing some useful functions.
```{r}
...
# we compate the gini estimators through a plot as a function of n
par(mfrow = c(1, 2))
plot(x = sample_sizes, y = matrix["gini-bias-mle", ], main = "", xlab = "n", ylab = "Gini MLE biases", col = "darkorange")
plot(x = sample_sizes, y = matrix["gini-bias-mme", ], main = "", xlab = "n", ylab = "Gini MME biases", col = "blueviolet")

par(mfrow = c(1, 2))
plot(x = sample_sizes, y = matrix["gini-variance-mle", ], main = "", xlab = "n", ylab = "Gini MLE variances", col = "darkorange")
plot(x = sample_sizes, y = matrix["gini-variance-mme", ], main = "", xlab = "n", ylab = "Gini MME variances", col = "blueviolet")

par(mfrow = c(1, 2))
plot(x = sample_sizes, y = matrix["gini-mse-mle", ], main = "", xlab = "n", ylab = "Gini MLE Mean Squared Error", col = "darkorange")
plot(x = sample_sizes, y = matrix["gini-mse-mme", ], main = "", xlab = "n", ylab = "Gini MME Mean Squared Error", col = "blueviolet")
```
...
par(mfrow = c(1, 3))
hist(result_n20, breaks = 50, main = "sample size: n = 20", xlab = "$\\sqrt{n}(\\hat{G}_{\\text{MLE}} - G_{\\theta_1^0, \\theta_2^0} )$", col = "coral")
hist(result_n100, breaks = 50, main = "sample size: n = 100", xlab = "$\\{n}(\\hat{G}_{\\text{MLE}} - G_{\\theta_1^0, \\theta_2^0} )$", col = "aquamarine3")
