...
par(mfrow = c(1, 2))
hist(gini_mle_sample, breaks = 50, main = "", xlab = "Gini MLE sample", col = "darkorange")
abline(v = gini_theoretical(theta_1), col = "darkgreen", lty = 2)
hist(gini_mme_sample, breaks = 50, main = "", xlab = "Gini MME sample", col = "steelblue")
abline(v = gini_theoretical(theta_1), col = "darkgreen", lty = 2)
...
ggsave("../report/figures/gini_bias_plot.pdf")
...
ggsave("../report/figures/gini_var_plot.pdf")
...
ggsave("../report/figures/gini_mse_plot.pdf")
```
